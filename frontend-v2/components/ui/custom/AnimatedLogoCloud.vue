<template>
    <div class="w-full py-12">
      <div class="mx-auto w-full px-4 md:px-8">
        <div
          v-if="props.title"
          class="text-center text-xl mb-4 font-afterglow"
        >
          {{ props.title }}
        </div>
        <div class="w-36 mx-auto h-[2px] mt-2 bg-gradient-to-r from-transparent via-secondary to-transparent"></div>
        <div
          :class="
        ...
        >
          ...
          >
            <img
              ...
              :src="logo.path"
              :alt="logo.name"
              class="h-14 w-36 px-3 brightness-0 dark:invert"
            />
          </div>
        </div>
      </div>
  ...
  import type { AnimateLogoCloudProps } from "../../../types/api";
